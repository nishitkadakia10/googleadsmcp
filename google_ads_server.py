...
def get_credentials():
    """
    Get server-side credentials for Google Ads API.
    ...
    logger.info(f"Using server-side authentication type: {auth_type}")
    ...
    if auth_type == "service_account":
        ...
        raise ValueError(
            "Unsupported GOOGLE_ADS_AUTH_TYPE for a remote server. "
            "Please use 'service_account'."
        )
